...
const Views = () => {
  ...
  const settings = {
    ...
    responsive: [
      {
        breakpoint: 1024,
        settings: { slidesToShow: 4, slidesToScroll: 1, infinite: false, dots: false },
      },
      {
        breakpoint: 768,
      ...
      {
        breakpoint: 480,
        settings: { slidesToShow: 2, slidesToScroll: 1, infinite: false, dots: false },
      },
    ],
  };
  ...
  return (
    <div className={styles.viewCon}>
      ...
      <h3 className={styles.viewSubHeading}>Have Control, Have the Predictability and Have Clear View</h3>
      <Slider {...settings}>
